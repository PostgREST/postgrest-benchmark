...
export let options = {
  ...
  scenarios: {
    constant_request_rate: {
      ...
      rate: 700, //setting 700 leads to dropped iterations
      timeUnit: '1s',
      duration: '30s',
      preAllocatedVUs: 100,
      maxVUs: 600,
...
export default function() {
  ...
  let body = JSON.stringify(Array(20).fill(obj));
  let res = http.post(URL + "/employee?columns=" + Object.keys(obj).reduce((x, y) => x + "," + y),
